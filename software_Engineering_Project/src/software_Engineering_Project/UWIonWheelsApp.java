...
//users(student and staff)
	public static void usermenu() {
		...
		bikeRentalButton.addActionListener(e -> new BicycleRental());
		paymentMethodsButton.addActionListener(e -> PaymentPlan.main(null));
...
// Method to create a JButton with specific styling
	private static JButton createButton2(String text) {
		JButton button = new JButton(text);
		button.setPreferredSize(new Dimension(200, 30));
		return button;
	}
